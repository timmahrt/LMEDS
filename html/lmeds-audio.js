...
var LmedsAudio = function () {
    ...
    this.mime_type_dict = {
        	...
        	".webm":"webm",
        	".ogg":"ogg"};
    this.media_type_dict = {AUDIO:"audio", VIDEO:"video"};
...
//    this.me = this;
//    this.a = this.recPlayAudioList.bind(this)
...
LmedsAudio.prototype.recPlayAudioList = function(audioList, pauseDurationMS, autoSubmit, me) {
    ...
    if (audioList.length > 0) {
        setTimeout(function(){me.recPlayAudioList(audioList, pauseDurationMS, autoSubmit, me);},
                   timeout);
    }
